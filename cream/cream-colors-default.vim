"
" Filename: cream-colors-default.vim
"
...
highlight NonText         guifg=#88ddff gui=none
highlight SpecialKey      guifg=#88ddff gui=none

" statusline
highlight User1  gui=bold guifg=#aaaaaa guibg=#f3f3f3
...
highlight DoubleWord gui=bold guifg=DarkBlue guibg=#ffeecc ctermfg=black ctermbg=lightblue

" current line
highlight CurrentLine term=reverse ctermbg=0 ctermfg=14 gui=none guibg=#ffffcc
highlight CursorLine term=reverse ctermbg=0 ctermfg=14 gui=none guibg=#ffffcc
highlight CursorColumn term=reverse ctermbg=0 ctermfg=14 gui=none guibg=#ffeedd
